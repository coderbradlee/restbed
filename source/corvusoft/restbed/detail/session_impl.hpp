    ...
    namespace detail
    {
        ...
        class SessionImpl
        {
            public:
                ...
                void parse_request( const boost::system::error_code& error, const std::shared_ptr< Session > session, const std::function< void ( const std::shared_ptr< Session > ) >& callback );
